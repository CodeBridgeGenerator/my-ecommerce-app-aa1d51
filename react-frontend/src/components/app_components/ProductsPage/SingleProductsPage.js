...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">ImageURL</label><p><img id="imageURL" src={_entity?.imageURL} className="m-0 ml-3" width={300}  /></p></div>
